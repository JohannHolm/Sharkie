...
class Player extends MovableObject {
  ...
  IMAGES_SWIM = ['./img/1.Sharkie/3.Swim/1.png', './img/1.Sharkie/3.Swim/3.png', './img/1.Sharkie/3.Swim/5.png', './img/1.Sharkie/3.Swim/6.png'];
  IMAGES_IDLE = [
  ...
  IMAGES_HURT = ['./img/1.Sharkie/5.Hurt/2.Electric shock/1.png', './img/1.Sharkie/5.Hurt/2.Electric shock/2.png', './img/1.Sharkie/5.Hurt/2.Electric shock/3.png'];
  IMAGES_BUBBLE = [
  ...
  animate() {
    ...
    setInterval(() => {
      ...
      } else if (this.world.keyboard.SPACE && this.attack) {
      ...
      if (this.world.keyboard.SPACE) {
        ...
        this.world.keyboard.SPACE = false; // Reset E key state so we don't continuously trigger
      }
    }, 1000 / 7);
  }
