...
class Endboss extends MovableObject {
  ...
  constructor(player) {
     ...
     */
    this.IMAGES_HIT = ['./img/2.Enemy/3 Final Enemy/Hurt/1.png', './img/2.Enemy/3 Final Enemy/Hurt/2.png', './img/2.Enemy/3 Final Enemy/Hurt/3.png', './img/2.Enemy/3 Final Enemy/Hurt/4.png'];
