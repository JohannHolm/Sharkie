...
function openControl() {
  ...
  menu.innerHTML = `
        ...
        <div class="control-content"><img class="control-img img-cont" src="./img/1.Sharkie/Bubble trap/Bubble.png">SPACE / Bubble</div>
        <div class="control-content"><img class="control-img img-cont" src="./img/4. Marcadores/Poisen/Animada/2.png">D / Poisen</div>
            <div class="control-content"><img class="control-img" src="img/6.Botones/Key/arrow keys.png">▲ ▶ ▼  ◀  / SWIM</div>
        </div>
    `;
}

/**
 * Gener▶te and display the "Game Over" HTML in the main menu.
 */
